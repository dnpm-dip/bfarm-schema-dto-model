...
trait RDMappings extends Mappings[RDPatientRecord,RDSubmission]
{
  ...
  protected implicit val rdMolecular: List[RDNGSReport] => RDMolecular = {
    ...
    implicit val segregationAnalysis: Variant.SegregationAnalysis.Value => SegregationAnalysis.Value =
      Map(
        ...
        Variant.SegregationAnalysis.FromBothParents -> SegregationAnalysis.FromMotherAndFather
      )
  ...
  implicit val useCaseSubmission: mvh.Submission[RDPatientRecord] => RDSubmission =
